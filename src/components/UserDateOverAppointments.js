...
function UserDateOverAppointments() {
  ...
  return (
    <div>
      <div className="user_appointment mb-4" >
            ...
            <Link to={'/user_view_appointment/dateover'} className="fw-bold" id="blue_clr" >Date Over</Link>
          </div>
          <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
                ...
                return(
                  ...
                  <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                      <div class="d-flex ">
                        {
                          e.drvisited==true?<Link to={`/user_view_prescription/${e._id}`} ><button className='btn' id='btns_bg' >View Priscription</button></Link>:<p class="text-danger m-0" >
                          The Booking is Expired
                        </p>
                        }
            ...
            }):<h1 style={{padding:'30px',textAlign:'center'}}>No Bookings</h1>
        }
              </div>
            </div>
          </div>
...
export default UserDateOverAppointments
